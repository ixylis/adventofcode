...
validp = ["byr", "iyr", "eyr", "hgt", "hcl", "ecl", "pid"]
p= []
count = 0
    ...
    if i == "":
        ...
        for k in inpa2:
            ...
            if tag=="byr":
                ...
                if value[-2::]=="cm":
                    value2 = int(value[0:value.index("cm")])
                    if value2>=150 and value2<=193:
                        p.append(tag)
                elif value[-2::]=="in":
                    value2 = int(value[0:value.index("in")])
                    if value2>=59 and value2<=76:
                        p.append(tag)
